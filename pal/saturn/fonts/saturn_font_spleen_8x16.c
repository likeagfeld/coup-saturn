/**
 * saturn_font_spleen_8x16.c - spleen_8x16 font data for Saturn VDP1
 *
...
#include "saturn_font_spleen_8x16.h"
#include <stddef.h>

static const uint8_t s_font_spleen_8x16_1bpp[1520] = {
...
void saturn_font_spleen_8x16_desc(saturn_font_desc_t* desc)
{
    ...
    desc->name = "spleen_8x16";
    desc->data_1bpp = s_font_spleen_8x16_1bpp;
    desc->cell_width = 8;
    desc->cell_height = 16;
    desc->advance_x = 8;
    desc->first_char = 32;
